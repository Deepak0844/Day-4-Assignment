...
const countries = [
  ...
  let capitals = countries.forEach((countries) => { console.log("Country Name :",countries.name,",","Region :",countries.region,",","Sub Region :",countries.subregion,",","Population :",countries.population) });